...
namespace MusterLibrary.DataAccess.MSSQL
{
    ...
    {
        private string connectionString = "Data Source=DESKTOP-PNSFQ01;Initial Catalog=SHIPMUSTER;Integrated Security=true;TrustServerCertificate=True;";// TODO Need to pass these in somehow
